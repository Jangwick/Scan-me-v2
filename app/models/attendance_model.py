...
class AttendanceRecord(db.Model):
    ...
    def to_dict(self):
        ...
        return {
            ...
            'scan_time': self.scan_time.isoformat() if self.scan_time else None,  # Legacy compatibility
            'duration_minutes': self.get_duration(),
            'status': self.get_status(),
            'time_in_scanned_by': self.time_in_scanned_by,
            'time_out_scanned_by': self.time_out_scanned_by,
            'scanner_name': self.time_in_scanned_by_user.username if hasattr(self, 'time_in_scanned_by_user') and self.time_in_scanned_by_user else 'System',
